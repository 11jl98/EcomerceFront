...
const initialStateTaxForSelectBoxes = {
  icms: {
    tipo_tributacao: [
...
export  {initialStateInfoFiscal, initialStateTaxForSelectBoxes, initialStateObjectIcms, cleanObjectInfoFiscal}